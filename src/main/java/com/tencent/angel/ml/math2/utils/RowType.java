...
public enum RowType {
    ...
    T_DOUBLE_DENSE(0, RowType.T_DOUBLE_DENSE_VALUE),
    T_DOUBLE_DENSE_COMPONENT(1, RowType.T_DOUBLE_DENSE_COMPONENT_VALUE),
    T_DOUBLE_DENSE_LONGKEY_COMPONENT(2, RowType.T_DOUBLE_DENSE_LONGKEY_COMPONENT_VALUE),
    T_DOUBLE_SPARSE(3, RowType.T_DOUBLE_SPARSE_VALUE),
    T_DOUBLE_SPARSE_COMPONENT(4, RowType.T_DOUBLE_SPARSE_COMPONENT_VALUE),
    T_DOUBLE_SPARSE_LONGKEY(5, RowType.T_DOUBLE_SPARSE_LONGKEY_VALUE),
    T_DOUBLE_SPARSE_LONGKEY_COMPONENT(6, RowType.T_DOUBLE_SPARSE_LONGKEY_COMPONENT_VALUE),

    T_FLOAT_DENSE(7, RowType.T_FLOAT_DENSE_VALUE),
    T_FLOAT_DENSE_COMPONENT(8, RowType.T_FLOAT_DENSE_COMPONENT_VALUE),
    T_FLOAT_DENSE_LONGKEY_COMPONENT(9, RowType.T_FLOAT_DENSE_LONGKEY_COMPONENT_VALUE),
    T_FLOAT_SPARSE(10, RowType.T_FLOAT_SPARSE_VALUE),
    T_FLOAT_SPARSE_COMPONENT(11, RowType.T_FLOAT_SPARSE_COMPONENT_VALUE),
    T_FLOAT_SPARSE_LONGKEY(12, RowType.T_FLOAT_SPARSE_LONGKEY_VALUE),
    T_FLOAT_SPARSE_LONGKEY_COMPONENT(13, RowType.T_FLOAT_SPARSE_LONGKEY_COMPONENT_VALUE),


    T_LONG_DENSE(14, RowType.T_LONG_DENSE_VALUE),
    T_LONG_DENSE_COMPONENT(15, RowType.T_LONG_DENSE_COMPONENT_VALUE),
    T_LONG_DENSE_LONGKEY_COMPONENT(16, RowType.T_LONG_DENSE_LONGKEY_COMPONENT_VALUE),
    T_LONG_SPARSE(17, RowType.T_LONG_SPARSE_VALUE),
    T_LONG_SPARSE_COMPONENT(18, RowType.T_LONG_SPARSE_COMPONENT_VALUE),
    T_LONG_SPARSE_LONGKEY(19, RowType.T_LONG_SPARSE_LONGKEY_VALUE),
    T_LONG_SPARSE_LONGKEY_COMPONENT(20, RowType.T_LONG_SPARSE_LONGKEY_COMPONENT_VALUE),


    T_INT_DENSE(21, RowType.T_INT_DENSE_VALUE),
    T_INT_DENSE_COMPONENT(22, RowType.T_INT_DENSE_COMPONENT_VALUE),
    T_INT_DENSE_LONGKEY_COMPONENT(23, RowType.T_INT_DENSE_LONGKEY_COMPONENT_VALUE),
    T_INT_SPARSE(24, RowType.T_INT_SPARSE_VALUE),
    T_INT_SPARSE_COMPONENT(25, RowType.T_INT_SPARSE_COMPONENT_VALUE),
    T_INT_SPARSE_LONGKEY(26, RowType.T_INT_SPARSE_LONGKEY_VALUE),
    T_INT_SPARSE_LONGKEY_COMPONENT(27, RowType.T_INT_SPARSE_LONGKEY_COMPONENT_VALUE),
